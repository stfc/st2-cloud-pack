...
class OpenstackProject(OpenstackQueryBase):
    ...
    def _query_no_email(self, project: Project):
        """
        Returns true when a project has no email
        """
    ...
    def search_projects_name_contains(
        ...
        :param cloud_account: The associated clouds.yaml account
        :param name_snippets: List of name snippets that should be in the return project's names
        :return: A list of projects matching the query
        """
        selected_projects = self.search_all_projects(cloud_account)
    ...
    def search_projects_name_not_contains(
        ...
        :param cloud_account: The associated clouds.yaml account
        :param name_snippets: List of name snippets that should not be in the return project's names
        :return: A list of projects matching the query
        """
        selected_projects = self.search_all_projects(cloud_account)
    ...
    def search_projects_description_contains(
        self, cloud_account: str, description_snippets: List[str], **_
    ) -> List[Project]:
        """
        Returns a list of projects with names containing the snippets given
        :param cloud_account: The associated clouds.yaml account
        :param description_snippets: List of description snippets that should be in the return project's descriptions
        :return: A list of projects matching the query
        """
        selected_projects = self.search_all_projects(cloud_account)
        ...
        return self._query_api.apply_query(
            selected_projects,
            self._query_api.query_prop_contains("description", description_snippets),
        )

    def search_projects_description_not_contains(
        self, cloud_account: str, description_snippets: List[str], **_
    ) -> List[Project]:
        """
        Returns a list of projects with names that don't contain the snippets given
        :param cloud_account: The associated clouds.yaml account
        :param description_snippets: List of description snippets that should not be in the return project's
                                     descriptions
        :return: A list of projects matching the query
        """
        selected_projects = self.search_all_projects(cloud_account)
        ...
        return self._query_api.apply_query(
            selected_projects,
            self._query_api.query_prop_not_contains(
                "description", description_snippets
            ),
        )

    def search_projects_without_email(self, cloud_account: str, **_) -> List[Project]:
        """
        Returns a list of projects with that do not have a contact email assigned
        :param cloud_account: The associated clouds.yaml account
        :return: A list of projects matching the query
        """
        selected_projects = self.search_all_projects(cloud_account)
