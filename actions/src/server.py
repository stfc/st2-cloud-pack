...
from queryopenstack.utils import ValidateInputList
from queryopenstack.classes.list_servers import ListServers
...
class Server(OpenstackAction):
    def __init__(self, *args, **kwargs):
        ...
        self.func = {
            ...
            "server_shutoff_per_user": lambda **kwargs: self.get_user_output(
                result_list=self.get_servers(
                    base_criteria=[["status", "SHUTOFF"]],
                    criteria_list = kwargs["search_criteria"] if "search_criteria" in kwargs.keys() else None,
                    properties_to_select=kwargs["properties_to_select"],
            ...
            "server_error_per_user": lambda **kwargs: self.get_user_output(
                result_list=self.get_servers(
                    base_criteria=[["status", "ERROR"]],
                    criteria_list = kwargs["search_criteria"] if "search_criteria" in kwargs.keys() else None,
                    properties_to_select=kwargs["properties_to_select"],
            ...
            "server_list_older_than_per_user": lambda **kwargs: self.get_user_output(
                result_list=self.get_servers(
                    base_criteria=[["older_than", kwargs["days"]]],
                    criteria_list=kwargs["search_criteria"] if "search_criteria" in kwargs.keys() else None,
                    properties_to_select=kwargs["properties_to_select"],
            ...
            "server_list_younger_than_per_user": lambda **kwargs: self.get_user_output(
                result_list=self.get_servers(
                    base_criteria=[["not_older_than", kwargs["days"]]],
                    criteria_list=kwargs["search_criteria"] if "search_criteria" in kwargs.keys() else None,
                    properties_to_select=kwargs["properties_to_select"],
    ...
    def get_user_output(self, result_list, get_html):
        """
