        ...
        self.func = {
            "server_list_shutoff": lambda **kwargs: self.get_output(
                result_list=self.get_servers(
                    ...
                    criteria_list=kwargs["search_criteria"]
                    if "search_criteria" in kwargs.keys()
                    else None,
                    properties_to_select=kwargs["properties_to_select"],
                    sort_by_criteria=kwargs["sort_by_criteria"]
                    if "sort_by_criteria" in kwargs.keys()
                    else None,
                ),
