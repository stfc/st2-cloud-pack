...
class FlavorPropertiesSensor(PollingSensor):
    ...
    * self._poll_interval
    ...
    def poll(self):
        """
        Polls source cloud flavors and compares their properties against the target cloud.
        Dispatches a payload if differences are found or the flavor is missing.
        """
