...
@patch("apis.email_api.emailer.Emailer.build_email_body")
...
@patch("apis.email_api.emailer.Emailer.build_email_body")
@patch("apis.email_api.emailer.Emailer.attach_files")
@patch("apis.email_api.emailer.MIMEMultipart")
...
@patch("apis.email_api.emailer.MIMEText")
...
@patch("apis.email_api.emailer.MIMEText")
@patch("apis.email_api.emailer.CSSInliner")
@patch("apis.email_api.emailer.EmailTemplateDetails")
