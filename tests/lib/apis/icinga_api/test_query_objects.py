...
from apis.icinga_api.query_objects import query_object
from apis.icinga_api.query_objects import IcingaQuery


@patch("apis.icinga_api.query_objects.requests.post")
