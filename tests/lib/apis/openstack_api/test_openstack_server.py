...
def test_set_metadata_happy_path():
    """
    ...
    set_metadata(mock_conn, server_id, properties_to_add)
...
def test_delete_metadata_happy_path():
    """
    ensures that the Server object found is the one passed
    as argument to delete_server_metadata()
    ensures all_projects is set to True
    ...
    delete_metadata(mock_conn, server_id, properties_to_delete)
