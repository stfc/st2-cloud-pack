...
@patch("workflows.send_mailing_list_capi_image_decom_email.EmailTemplateDetails")
@patch("workflows.send_mailing_list_capi_image_decom_email.EmailParams")
...
@patch(
    "workflows.send_mailing_list_capi_image_decom_email.get_affected_images_plaintext"
)
...
def test_send_mailing_list_capi_image_decom_email_send_plaintext(
    mock_emailer,
...
@patch("workflows.send_mailing_list_capi_image_decom_email.print_email_params")
def test_send_mailing_list_capi_image_decom_email_print_email(
